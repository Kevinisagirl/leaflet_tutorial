...
We now want to color by a feautre of our data, the percentage of growth from 2010 to 2017 in each state. First, we need to create our color scale for this data. We can do this manually by inspecting the range of our data.
```{r}
hist(pop.change$percentagegrowth)
```

...
This tutorial is based partially on the tutorial: http://rstudio.github.ip/leaflet/choropleths.html
...
```{r}
# Reorder the census data to match the order of the states in the SpatialPolygonsDataFrame
